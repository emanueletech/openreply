...
const navLinks = [
  { label: "Modelli", href: "/templates", key: "templates" },
  { label: "Agenzie", href: "/instagram-dm-automation-agencies", key: "agencies" },
  { label: "Prezzi", href: "/#pricing", key: "pricing" },
  { label: "Sicurezza", href: "/#security", key: "security" },
];
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-background/85">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-5 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3" aria-label="Home di OpenReply">
